...
if not defined FLOWITH_HERMES_SINGLE_ANSWER set "FLOWITH_HERMES_SINGLE_ANSWER=true"
...
echo.
echo =====================================
echo   Flowith Hermes Agent Proxy
echo   Base URL:  http://127.0.0.1:%FLOWITH_API_PORT%
echo   OpenAI:    http://127.0.0.1:%FLOWITH_API_PORT%/v1
...
echo   Base URL: http://127.0.0.1:%FLOWITH_API_PORT%/v1
echo   API Key:  use FLOWITH_API_KEY from claude-proxy\.env
echo.
